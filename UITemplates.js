...
export const FRIENDS_MODAL_HTML = `
    <style>
        ...
        .friends-full-container {
            ...
            background-color: #1e375a; /* Ciemny granat tła */
            display: flex; flex-direction: column;
            position: relative;
            padding-top: 60px; /* Miejsce na górny pasek HUD */
        }

        /* GÓRNA NAWIGACJA ZAKŁADEK */
        .friends-nav-bar {
        ...
        .friends-section-header {
            color: #00cec9; /* Cyjanowy kolor nagłówków */
        ...
        .friend-card-body {
            ...
            background-image: url('icons/avatar_placeholder.png'); /* Fallback */
            background-size: cover; background-position: center;
            position: relative;
        }
        ...
        .vip-badge {
            ...
            background: url('icons/vip_badge.png') center/contain no-repeat; /* Atrapa */
        }
