...
export class UIManager {
  ...
  renderUI() {
      ...
      // FIX: JAWNE SKLEJANIE WSZYSTKICH SZABLONÓW (aby uniknąć brakujących ID)
      if (modalsLayer) {
          modalsLayer.innerHTML = MODALS_HTML + SKIN_DETAILS_HTML + SKIN_COMMENTS_HTML + DISCOVER_CHOICE_HTML + NEWS_MODAL_HTML;
      }
  }
