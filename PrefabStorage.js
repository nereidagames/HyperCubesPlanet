...
### **2. NOWY PLIK: `PrefabBuilderManager.js`**

*Stwórz nowy plik o tej nazwie. Jest to nowy manager do tworzenia prefabrykatów.*
...
export class PrefabBuilderManager {
  ...
  setupBuildEventListeners() {
    ...
    document.getElementById('build-save-button').onclick = () => this.savePrefab();
  }
